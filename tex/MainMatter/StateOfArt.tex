...
The term was coined for Apple's liquid computing feature and  refers to a style of workflow interaction of applications and computing services across multiple devices, such as computers, smartphones, and tablets.\\
...
\begin{itemize}
	...
	\item Microsoft One Drive synch is a system, developed by microsoft to allow users to synchronize setting among their devices like desktops, notebook smartphones and so on.
\end{itemize}
