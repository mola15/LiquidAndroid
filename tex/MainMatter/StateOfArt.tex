...
\begin{figure}[h!]
	\centering
	\includegraphics[width=0.95\textwidth]{intentresolution}
...
The most important security techniques adopted by Android are the followings.
	...
	\begin{figure}[h]
		...
		\begin{minipage}{.49\textwidth}\centering
			\subfloat[Android 5.1- permission example\label{subfig-1:5.1}]{%
				\includegraphics[width=0.95\textwidth]{51permissions}
			}
		\end{minipage}
		\begin{minipage}{.49\textwidth}\centering
			\subfloat[Android 6.0+ permission example\label{subfig-2:6.0}]{%
				\includegraphics[width=0.95\textwidth]{60permissions}
			}
		\end{minipage}
...
\begin{figure}[ht!]
	\centering
	\includegraphics[width=0.7\textwidth]{p2p}
