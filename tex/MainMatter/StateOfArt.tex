...
\par As already mentioned, the Android operating system is an open source OS developed by Google based on Linux kernel, that can be installed on many different kind of devices.\\
...
I want to provide, in this subsection, a brief analysis of two more concrete solutions for the problems faced in this thesis work.
